...
public final class BlockSelectionScreen extends Screen {
	...
	private int getTiles(int var1, int var2) {
	...
	public final void render(int var1, int var2) {
		...
		var2 = var7.loadTexture("/terrain.png");
	...
	protected final void mouseClicked(int var1, int var2, int var3) {
		if(var3 == 0) {
			this.minecraft.player.inventory.replaceSlot(this.getTiles(var1, var2));
