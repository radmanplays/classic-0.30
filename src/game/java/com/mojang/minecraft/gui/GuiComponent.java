...
public class GuiComponent {
	...
	public final void blit(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		var9.begin();
		var9.vertexUV((float)var1, (float)(var2 + var6), this.blitOffset, (float)var3 * var7, (float)(var4 + var6) * var8);
		var9.vertexUV((float)(var1 + var5), (float)(var2 + var6), this.blitOffset, (float)(var3 + var5) * var7, (float)(var4 + var6) * var8);
		var9.vertexUV((float)(var1 + var5), (float)var2, this.blitOffset, (float)(var3 + var5) * var7, (float)var4 * var8);
		var9.vertexUV((float)var1, (float)var2, this.blitOffset, (float)var3 * var7, (float)var4 * var8);
		var9.end();
	}
}
