...
public final class WaterTexture extends DynamicTexture {
	...
	public final void tick() {
		...
		for(var2 = 0; var2 < 256; ++var2) {
			...
			this.pixels[var2 << 2] = (byte)var5;
			this.pixels[(var2 << 2) + 1] = (byte)var6;
			this.pixels[(var2 << 2) + 2] = (byte)var1;
			this.pixels[(var2 << 2) + 3] = (byte)var10;
		}
