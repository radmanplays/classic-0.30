...
public final class MobSpwaner {
	public Level level;

	public MobSpwaner(Level var1) {
		this.level = var1;
	}

	public final int spawnMobs(int var1, Entity var2, LevelLoaderListener var3) {
		int var4 = 0;
		...
		for(int var5 = 0; var5 < var1; ++var5) {
			...
			if(!this.level.isSolidTile(var7, var8, var9) && this.level.getLiquid(var7, var8, var9) == Liquid.none && (!this.level.isLit(var7, var8, var9) || this.level.random.nextInt(5) == 0)) {
